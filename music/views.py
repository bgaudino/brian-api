...
class ScoreListView(APIView):
    def get(self, request):
        ...
        try:
            offset = int(request.query_params.get("offset", 0)) * rows_per_page
        except ValueError:
            offset = 0
        ...
        if (
            "percentage" in order_by
            or "num_attempted" in order_by
            or "name" in order_by
        ):
        ...
        return Response({"count": count, "scores": serializer.data})
